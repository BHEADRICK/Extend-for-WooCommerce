<?php
/**
 * Extend_For_WooCommerce Test Bootstrapper.
 *
 * @since   0.0.0
 ...
 * @since 0.0.0
 */
function _manually_load_extend_for_woocommerce_plugin() {
	...
	// Require our plugin.
	require dirname( dirname( __FILE__ ) ) . '/extend-for-woocommerce.php';
}

// Inject in our plugin.
tests_add_filter( 'muplugins_loaded', '_manually_load_extend_for_woocommerce_plugin' );
